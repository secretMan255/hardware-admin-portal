...
export const UpdateParentId = ({ onUpdateParentId }: UpdateParentId) => {
     ...
     const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
          ...
          try {
               await CallApi.updateItemParentId(Number(originalId), Number(newId))
     ...
     return (
          <Dialog open={open} onOpenChange={setOpen}>
               ...
               <DialogContent>
                    <DialogHeader>
                         <DialogTitle>Item Parent ID</DialogTitle>
                         <DialogDescription id="dialog-description">Fill in the item's parent id and new parent id</DialogDescription>
                    </DialogHeader>
